...
on_exit() {
    ...
    # Ожидание завершения фоновых процессов или таймаута,
    # установленного в TimeoutStopSec, или 90 секунд по дефолту
    wait
...
# ifup host0
# Если в /etc/network/interfaces настроек нет, то
